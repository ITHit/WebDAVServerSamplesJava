  ...
  <head>
	...
	<script type="text/javascript">
	    ...
	    function InitAjaxFileBrowser() {
          ...
          var webDavFolderUrl = window.opener != null ? window.opener.WebDAVController.GetMountUrl() : '/';
          var selectedFolder = window.opener != null ? window.opener.location.href : '/';

	        // Customize the look of Ajax File Browser below
	        // https://www.webdavsystem.com/ajaxfilebrowser/programming/settings_reference
	        var settings = {
	            ...
	            MsOfficeTemplatesPath: webDavFolderUrl + 'Templates/',   // path to MS Office templates, always specify full path including domain: https://server/path/
	            SelectedFolder: selectedFolder,                          // folder to be selected, same as SetSelectedFolderAsync call
	            ThemeName: 'windows_8',                                  // theme name (folder name under /themes/ folder: 'clean', 'golden', etc), see themes here: https://ajaxbrowser.com/?themesdemo
