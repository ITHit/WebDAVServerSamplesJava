...
public class DataAccess {
    ...
    List<HierarchyItemImpl> readItems(String sql, final String path, final boolean parentPath, Object... args) throws ServerException {
        ...
        ElementReader<HierarchyItemImpl> elementReader = rs -> {
            ...
            boolean versionControlled = "Y".equals(rs.getString("VersionControlled"));
            boolean checkedOut = "Y".equals(rs.getString("CheckedOut"));
            boolean checkInDuringUnlock = "Y".equals(rs.getString("CheckinDuringUnlock"));
            boolean checkInOnFileComplete = "Y".equals(rs.getString("CheckinOnFileComplete"));
            AutoVersion autoVersion = AutoVersion.valueOf(rs.getString("AutoVersion"));
     ...
     * @throws ServerException in case of DB exception.
     */
    List<VersionImpl> readVersions(String sql, final String itemPath, Object... args) throws ServerException {
        ElementReader<VersionImpl> elementReader = rs -> {
            int versionId = rs.getInt("Id");
            int itemId = rs.getInt("ItemId");
            int versionNumber = rs.getInt("VersionNumber");
            long created = rs.getTimestamp("Created").getTime();

            return new VersionImpl(engine, versionId, itemId, itemPath, versionNumber, created);
        };
